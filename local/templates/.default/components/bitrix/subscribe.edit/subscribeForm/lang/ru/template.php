...
$MESS ['subscr_form_button'] = "Отправить";
$MESS ['subscr_form_header'] = "Оставайтесь информационно подкованными!";
$MESS ['subscr_form_descr'] = "Подписывайтесь на нашу рассылку и первыми получайте специальные предложения, акции и распродажи!";
?>