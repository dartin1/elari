...
<div class="product-card woocommerce">
    <? if ($itemHasDetailUrl): ?>
	...
	<? endif; ?>
		...
		<span class="product-item-image-original" id="<?= $itemIds['PICT'] ?>"
            ...
            if ($item['LABEL']) {
                ?>
                <div class="product-item-label-ring <?= $labelPositionClass ?>" id="<?= $itemIds['STICKER_ID'] ?>">
				<?
            ...
            switch ($blockName) {
                ...
                case 'quantity':
                    if (!$haveOffers) {
                        if ($actualItem['CAN_BUY'] && $arParams['USE_PRODUCT_QUANTITY']) {
                            ?>
                            <input hidden class="product-item-amount-field" id="<?= $itemIds['QUANTITY'] ?>"
                                   type="number"
                        ...
                        if (!$haveOffers) {
                            if ($actualItem['CAN_BUY']) {
                                ...
                                <div class="product-item-button-container">
                                    ...
                                    ?>
                                    <a class="btn btn-default <?= $buttonSizeClass ?>" disabled
                                       href="javascript:void(0)" rel="nofollow">
                                        <?= ($arParams['ADD_TO_BASKET_ACTION'] === 'BUY' ? $arParams['MESS_BTN_BUY'] : $arParams['MESS_BTN_ADD_TO_BASKET']) ?>
                                    </a>
                                </div>
                ...
                case 'sku':
                    if ($arParams['PRODUCT_DISPLAY_MODE'] === 'Y' && $haveOffers && !empty($item['OFFERS_PROP'])) {
                        ?>
                        <div id="<?= $itemIds['PROP_DIV'] ?>" hidden>
                            <?
