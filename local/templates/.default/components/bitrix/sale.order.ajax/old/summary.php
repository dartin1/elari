...
<div id="order_review" class="woocommerce-checkout-review-order">
    <table class="shop_table woocommerce-checkout-review-order-table">
        ...
        <? foreach ($arResult["GRID"]["ROWS"] as $k => $arData): ?>
            <tr class="cart_item">
                <td class="product-name">
                    <?= $arData["data"]["NAME"] ?><strong
                        class="product-quantity">× <?= $arData["data"]["QUANTITY"] ?></strong>
                    <dl class="variation">
        ...
        <tr class="order-total">
            <th>Всего</th>
            <td><strong><span
                        class="woocommerce-Price-amount amount"><?= $arResult["ORDER_TOTAL_PRICE_FORMATED"] ?></span></strong>
            </td>
        </tr>
        </tfoot>
    </table>
