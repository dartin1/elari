                ...
                <div class="bx_element">
                    ...
                    <label for="ID_DELIVERY_ID_<?= $arDelivery["ID"] ?>">
                        ...
                        <div class="bx_logotype"><span
                                style='background-image:url(<?= $deliveryImgURL ?>);' <?= $clickHandler ?>></span></div>
                        ...
                        <div class="bx_description">
                            ...
                            <p <?= $clickHandler ?>>
                                ...
                                if (count($arDelivery["STORE"]) > 0 && $arDelivery['CHECKED'] == 'Y'):
                                    ?>
                                    <span
                                        id="select_store"<? if (strlen($arResult["STORE_LIST"][$arResult["BUYER_STORE"]]["TITLE"]) <= 0) echo " style=\"display:none;\""; ?>>
