...
$APPLICATION->SetPageProperty("title", "Умные решения для умных людей");
$APPLICATION->SetTitle("Умные решения для умных людей");
?>
...
<? $APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "OFFER_TREE_PROPS" => array(0 => "COLOR_REF", 3 => "",),
        ...
        "SEF_FOLDER" => "/catalog/",
        "SEF_MODE" => "Y",
        "SEF_URL_TEMPLATES" => Array("compare" => "", "element" => "#ELEMENT_CODE#/", "section" => "", "sections" => "", "smart_filter" => ""),
        "SET_LAST_MODIFIED" => "N",
        "SET_STATUS_404" => "Y",
        "SET_TITLE" => "Y",
        "SHOW_404" => "N",
